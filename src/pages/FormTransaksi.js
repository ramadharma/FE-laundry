            ...
            <div className="container">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        Tanggal Transaksi
                        <input type="date" className="form-control mb-2" value={this.state.tgl} onChange={ev => this.setState({ tgl: ev.target.value })} />

                        Batas waktu
                        <input type="date" className="form-control mb-2" value={this.state.batas_waktu} onChange={ev => this.setState({ batas_waktu: ev.target.value })} />

                        Tanggal Bayar
                        <input type="date" className="form-control mb-2" value={this.state.tgl_bayar} onChange={ev => this.setState({ tgl_bayar: ev.target.value })} />
                        ...
                        <button type="submit" className="btn btn-success" onClick={() => this.simpanTransaksi()}>
                            Simpan transaksi
                        </button>
                    </div>
                </div>
